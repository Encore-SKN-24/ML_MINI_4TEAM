...
- 지속 가능한 경제의 축
지난 10년간 K-컬처 산업은 매출 2.3배, 수출 3.9배라는 경이적인 기록을 달성하며 양적 성장을 이뤄냈습니다. 본 프로젝트의 분석 결과 또한 이러한 흐름을 뒷받침합니다.
- K-푸드와 뷰티에 대한 SNS 관심도는 단순한 바이럴을 넘어 우상향 곡선을 그리고 있습니다.이는 K-컬쳐가 일시적인 유행이 아닌 지역 경제를 지탱하는 축으로 자리 잡았음을 의미하며, 앞으로도 이 트랜드는 강력한 소비 동력이 되어 지역 상관을 활성화할 것입니다.
